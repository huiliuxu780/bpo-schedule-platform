...
import { MasterDataMaintenanceWorkbench } from "@/components/master-data-maintenance-workbench"
import {
...
export default async function MasterDataMaintenancePage() {
  const batchResult = await fetchImportBatches()

  return (
    <AppShell title="主数据维护" searchPlaceholder="搜索主数据对象或来源批次">
      <MasterDataMaintenanceWorkbench
