...
const nav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "班次类型", href: "/shift-types", activeMatch: "exact" },
      { title: "不可用管理", href: "/unavailability", activeMatch: "exact" },
    ],
  },
  {
    title: "履约监控",
    icon: ClipboardCheck,
    items: [
      { title: "履约日历", href: "/person-timeline", activeMatch: "prefix" },
      { title: "异常复核", href: "/anomaly-review", activeMatch: "exact" },
      { title: "异常来源", href: "/anomaly-review/sources", activeMatch: "prefix" },
      { title: "复核时间线", href: "/anomaly-review/timeline", activeMatch: "exact" },
    ],
  },
  {
    title: "数据与集成",
    icon: Database,
    items: [
      { title: "接入批次", href: "/import-batches", activeMatch: "prefix" },
      { title: "字段映射", href: "/field-mapping", activeMatch: "exact" },
      { title: "导入模板", href: "/import-templates", activeMatch: "exact" },
      { title: "数据质量", href: "/data-quality", activeMatch: "prefix" },
      { title: "主数据关系", href: "/master-data-relations", activeMatch: "exact" },
    ],
  },
]
