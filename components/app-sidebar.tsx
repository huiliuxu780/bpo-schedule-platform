...
const nav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "班次类型", href: "/shift-types", activeMatch: "exact", tag: "新" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "预测实际对齐", href: "/production-mvp/alignment-readiness", activeMatch: "prefix", tag: "新" },
      { title: "异常识别准备", href: "/production-mvp/anomaly-triage-readiness", activeMatch: "prefix", tag: "新" },
      { title: "治理边界准备", href: "/production-mvp/governance-readiness", activeMatch: "prefix", tag: "新" },
