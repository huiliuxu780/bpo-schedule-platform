...
- scope: frontend local business function: upgrade `/person-timeline` into fulfillment calendar, add local aggregation for team week, group week, member day matrix, keep drilldown as one visible layer at a time, preserve personal day three-track detail, and update focused tests and traceability.
