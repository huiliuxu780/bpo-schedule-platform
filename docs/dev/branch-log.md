...
- branch_name: `codex/f412-login-status-logs`
- base_main_commit: `a3a134c`
- base_chain_commit: `1c16707`
- remote_status: `not_pushed`
- scope: QA closeout for actual-log source evidence write-through, covering source extraction, review source references, evidence defaults, browser smoke, and no-database/no-production-action boundary.
- allowed_files_check: `docs/**` and `tasks/backlog.yaml`; no backend, app, components, lib, package, lockfile, dependency, database, ORM, migration, external integration, auth, permission, approval, export, batch operation, file storage, Excel xlsx parsing, automatic scheduling, production formula, settlement rule, or charge-factor files.
- scope_diff_check: updates current queue, active tasks, backlog/story status, audit, task log, project context, and branch log only.
- check_result: target frontend tests, browser smoke, strict state check, diff whitespace check, and final `bash scripts/check.sh` passed.
- local_commit_sha: `pending`
...
### F418 Actual Log Source Evidence

- branch_name: `codex/f412-login-status-logs`
- base_main_commit: `a3a134c`
- base_chain_commit: `bffda3c`
- remote_status: `not_pushed`
- scope: frontend local evidence write-through: derive actual-log source references from schedule-vs-actual anomalies, quality issues, and actual intervals, show them in the local closure card, and default review/evidence forms to those records.
...
- scope_diff_check: updates existing `/person-timeline` local closure form, actual fulfillment model/test, and current/legacy traceability docs; no new route, sidebar entry, backend, package, lockfile, database, real integration, permission, approval, export, batch, automatic scheduling, production formula, settlement rule, or charge-factor files.
- check_result: TDD red observed for missing `getActualFulfillmentEvidenceReferences`; target model/page tests, product UI copy audit, navigation regression, typecheck, browser smoke, strict state check, diff whitespace check, and final `bash scripts/check.sh` passed.
- local_commit_sha: `pending`
- integration_status: `not_started`
- integration_method: `N/A`
- integration_commit_sha: `N/A`
...
### Q124 Actual Fulfillment Visibility QA

- branch_name: `codex/f412-login-status-logs`
- base_main_commit: `a3a134c`
- base_chain_commit: `6381f7b`
- remote_status: `not_pushed`
- scope: QA closeout for the actual-log frontend visibility pass, covering frontend contract model, fulfillment calendar visible panel, browser smoke, and no-database/no-production-action boundary.
- allowed_files_check: `docs/**` and `tasks/backlog.yaml`; no backend, app, components, lib, package, lockfile, dependency, database, ORM, migration, external integration, auth, permission, approval, export, batch operation, file storage, Excel xlsx parsing, automatic scheduling, production formula, settlement rule, or charge-factor files.
- scope_diff_check: updates current queue, active tasks, backlog/story status, audit, task log, project context, and branch log only.
- check_result: target frontend tests, browser smoke, strict state check, diff whitespace check, and final `bash scripts/check.sh` passed.
- local_commit_sha: `pending`
...
- branch_name: `codex/f412-login-status-logs`
- base_main_commit: `a3a134c`
- base_chain_commit: `299fa78`
- remote_status: `not_pushed`
- scope: backend-vertical local actual-log interval slice: generate 0.5h actual-log interval records from imported login/status process-memory records, compute login/status/productive minutes, retain source log IDs and status types, and expose status gap/overlap quality issues.
- allowed_files_check: `app/person-timeline/**`, `backend/**`, `lib/**`, `scripts/tests/**`, `docs/**`, and `tasks/backlog.yaml`; no package, lockfile, dependency, database, ORM, migration, external integration, auth, permission, approval, export, batch operation, file storage, Excel xlsx parsing, automatic scheduling, production formula, settlement rule, or charge-factor files.
...
- branch_name: `codex/f409-demand-forecast-import`
- base_main_commit: `a3a134c`
- base_chain_commit: `8513189`
- remote_status: `not_pushed`
- scope: backend-vertical local demand-forecast version-change slice: detect repeated imports for the same forecast grain, retain previous and new source batch/version, forecast-agent deltas, and expose local change records without production persistence.
...
### F409 G001 Demand Forecast Import

- branch_name: `codex/f409-demand-forecast-import`
- base_main_commit: `a3a134c`
- base_chain_commit: `a158b41`
- remote_status: `not_pushed`
- scope: backend-vertical local demand-forecast import slice: require skill group and grade in demand forecast CSV, validate local workplace/project/skill/grade references, keep failed rows out of demand records, persist successful rows in process memory with source batch and forecast version, and expose imported forecast traceability through demand plan reads and alignment models.
...
- branch_name: `codex/f397-data-quality-owner-handoff-brief`
- base_main_commit: `a3a134c`
- base_chain_commit: `db05864`
- remote_status: `pushed`
- scope: frontend local read-only function: add group step owner handoff brief summary to the data quality overview, turning owner review queue items into supervisor handoff wording for each responsible owner.
- allowed_files_check: `app/data-quality/page.tsx`, `lib/data-quality-groups.ts`, `scripts/tests/data-quality-groups.test.mjs`, `scripts/tests/data-quality.test.mjs`, `docs/**`, and `tasks/backlog.yaml`; no backend interface, package, lockfile, dependency, database, ORM, migration, real external integration, auth, permission, approval, export, batch operation, Excel xlsx parsing, production status dictionary, automatic scheduling, production formula, settlement rule, or charge-factor files.
- scope_diff_check: updates existing data quality overview route, data quality group frontend model/test, data quality page source test, and current and legacy traceability docs; does not add backend endpoints, production persistence, new dependencies, external connectors, permission boundaries, approval, export, batch operation, production status dictionary, automatic scheduling, production formula, settlement rule, or charge-factor behavior.
- check_result: TDD red observed for missing group step owner handoff brief export and missing page source reference; data-quality group tests, data-quality tests, product copy/navigation tests, strict state check, local HTML smoke, diff whitespace check, and final `bash scripts/check.sh` passed.
- local_commit_sha: `69c462e`
- integration_status: `not_started`
- integration_method: `N/A`
- integration_commit_sha: `N/A`
- merge_to_main_commit: `N/A`
- push_decision: `PM confirmed push; pushed to origin/codex/f397-data-quality-owner-handoff-brief`
- blocked_reason: `N/A`
...
- local_commit_sha: `db05864`
- integration_status: `not_started`
- integration_method: `N/A`
- integration_commit_sha: `N/A`
- merge_to_main_commit: `N/A`
- push_decision: `PM confirmed push; pushed to origin/codex/f396-data-quality-owner-review-queue`
- blocked_reason: `N/A`
