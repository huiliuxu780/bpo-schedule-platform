...
`US750/IM130` through `US840/IM220` corrected visible product structure, fixed shared UI/util seams, migrated safe table abstractions, defined MainTableShell boundaries, closed dashboard anomaly scope, calibrated requirements/review-case QA, and split import-center plus master-data maintenance model gates. Current queue is empty; future live review-case acceptance still requires an approved 8000/API runtime.
