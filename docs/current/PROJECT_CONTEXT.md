...
Recommended next step is import-center batch detail readability polish or data-quality-to-exception trace visibility. Keep apply write buttons, multipart/Excel, external integrations, auth, permissions, approval, export, batch operations, automatic scheduling, production formulas, settlement rules, and charge factors out of scope until separate tasks.
