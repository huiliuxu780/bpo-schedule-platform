...
- Imported demo rows are exposed through localhost-only processed records and are now consumed by dashboard and shift-details for module-level demo summaries.
