...
module: "BPO WFM 三条主线"
role: "班组长"
story: "作为班组长，我希望在排班草稿板中手动调整人员班次和目标技能后，右侧标准人力缺口能够即时重算，以便在保存草稿前判断当前安排是否满足小组预测需求。"
task_type: "frontend-scaffold"
priority: "P0"
acceptance:
  - "保留 IM276 的 3 人覆盖但 2.2 标准人力仍不满足样例。"
  - "调整 tay 不覆盖 10:00-10:30 后，已排标准人力从 2.2 变为 2.0，缺口从 0.8 变为 1.0。"
  - "将 alex 加入 10:00-10:30 且计划投诉时，覆盖人数增加但投诉贡献仍为 0，并显示技能错配。"
  - "将 lily 1.0 加入 10:00-10:30 后，已排标准人力达到 3.0，缺口为 0，并显示满足。"
  - "调整交互不新增自动排班、真实保存、发布门槛、审批、权限、导出、批量、外部集成、生产公式、结算或收费因子。"
dependencies:
  - US867
status: "done"
notes: "IM277 已完成：班组长可用本地按钮切换草稿调整场景，并即时看到标准人力覆盖重算结果；浏览器 smoke 已验证 tay 移出、alex 技能错配、lily 补足三条路径。"
```

### US867 - 班组长排班板标准人力草稿闭环
...
module: "BPO WFM 三条主线"
role: "班组长"
story: "作为班组长，我希望在排班草稿工作台中看到本小组某时段某技能的预测标准人力，安排具体员工班次后实时看到已排标准人力、覆盖人数、贡献人员、缺口和原因，以便确认草稿是否满足需求，而不是只按人数判断。"
task_type: "frontend-scaffold"
priority: "P0"
acceptance:
  - "展示上海职场 / A 项目 / A 组 / 投诉 / 10:00-10:30 需求 3.0 标准人力。"
  - "排入 king 1.0、james 1.0、tay 0.2 后展示覆盖人数 3、已排标准人力 2.2、缺口 0.8。"
  - "覆盖人数为 3 仍判定不满足，并提示低能力补位。"
  - "无目标技能员工对投诉贡献为 0，并提示技能错配。"
  - "草稿有缺口仍允许保存，但必须显示缺口、原因和草稿预警。"
  - "不新增自动排班、审批、权限、导出、批量、外部集成、生产公式、结算或收费因子。"
status: "done"
notes: "IM276 已完成：班组长排班板 v0.1 作为一个完整中等切片交付，未拆成预测、人员级排班、覆盖计算、预警四个独立故事。"
```
...
module: "BPO WFM"
role: "班组长"
story: "作为班组长，我希望在排班草稿工作台看到多个半小时时段的标准人力缺口队列，并能切换到具体时段复核人员草稿和缺口原因，以便先处理最需要补位的时段。"
task_type: "frontend-scaffold"
priority: "P0"
acceptance:
  - "保留 IM276 的 10:00-10:30 3 人覆盖但 2.2 标准人力仍不满足、缺口 0.8 样例。"
  - "新增至少 3 个半小时时段的缺口队列，并按标准人力缺口从高到低排序。"
  - "10:30-11:00 显示已排 2.0、缺口 1.0，并作为优先补位项。"
  - "11:00-11:30 显示已排 3.0、缺口 0.0，并标记为已满足。"
  - "点击缺口队列中的时段后，主明细同步显示该时段的需求、人员贡献、缺口和原因。"
  - "不新增自动排班、真实保存、审批、权限、导出、批量操作、外部系统集成、生产公式、结算或收费因子。"
status: "done"
notes: "IM278 已完成：班组长可在 `/schedule-plans/new` 看到按缺口排序的多时段标准人力缺口队列，并点击切换主明细复核具体时段的人员贡献、缺口和原因。"
```
