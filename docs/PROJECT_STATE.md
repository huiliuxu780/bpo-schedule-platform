...
- Fulfillment calendar supervisor-side local read-only panels for exception review, closure readiness, closure risk, closure review summary, weekly decision digest, data-quality impact ranking, weekly data-quality summary, weekly owner pressure, weekly source pressure, and weekly review comparison.
